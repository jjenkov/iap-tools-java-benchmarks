...
public class IonStringReadBenchmark {
    ...
    public Object ionReadArray1000_10(IapState state, Blackhole blackhole) {
        PojoArray10String pojoArray10 = (PojoArray10String) state.readerArray10.read(state.dest1000_10, 0);
        blackhole.consume(pojoArray10);
        return pojoArray10;
    }
    ...
    public Object jsonRead1_1(JacksonState state, Blackhole blackhole) {
        try {
            Pojo1String pojo1 = state.objectMapper.readValue(state.bytesJson1_1, Pojo1String.class);
            blackhole.consume(pojo1);
            return pojo1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object jsonRead10_1(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray1String pojoArray1 = state.objectMapper.readValue(state.bytesJson10_1, PojoArray1String.class);
            blackhole.consume(pojoArray1);
            return pojoArray1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object jsonRead100_1(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray1String pojoArray1 = state.objectMapper.readValue(state.bytesJson100_1, PojoArray1String.class);
            blackhole.consume(pojoArray1);
            return pojoArray1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object jsonRead1000_1(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray1String pojoArray1 = state.objectMapper.readValue(state.bytesJson1000_1, PojoArray1String.class);
            blackhole.consume(pojoArray1);
            return pojoArray1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object jsonRead1_10(JacksonState state, Blackhole blackhole) {
        try {
            Pojo10String pojo10 = state.objectMapper.readValue(state.bytesJson1_10, Pojo10String.class);
            blackhole.consume(pojo10);
            return pojo10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object jsonRead10_10(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray10String pojoArray10 = state.objectMapper.readValue(state.bytesJson10_10, PojoArray10String.class);
            blackhole.consume(pojoArray10);
            return pojoArray10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object jsonRead100_10(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray10String pojoArray10 = state.objectMapper.readValue(state.bytesJson100_10, PojoArray10String.class);
            blackhole.consume(pojoArray10);
            return pojoArray10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object jsonRead1000_10(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray10String pojoArray10 = state.objectMapper.readValue(state.bytesJson1000_10, PojoArray10String.class);
            blackhole.consume(pojoArray10);
            return pojoArray10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object msgPackRead1_1(JacksonState state, Blackhole blackhole) {
        try {
            Pojo1String pojo1 = state.objectMapperMsgPack.readValue(state.bytesMsgPack1_1, Pojo1String.class);
            blackhole.consume(pojo1);
            return pojo1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object msgPackRead10_1(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray1String pojoArray1 = state.objectMapperMsgPack.readValue(state.bytesMsgPack10_1, PojoArray1String.class);
            blackhole.consume(pojoArray1);
            return pojoArray1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object msgPackRead100_1(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray1String pojoArray1 = state.objectMapperMsgPack.readValue(state.bytesMsgPack100_1, PojoArray1String.class);
            blackhole.consume(pojoArray1);
            return pojoArray1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object msgPackRead1000_1(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray1String pojoArray1 = state.objectMapperMsgPack.readValue(state.bytesMsgPack1000_1, PojoArray1String.class);
            blackhole.consume(pojoArray1);
            return pojoArray1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object msgPackRead1_10(JacksonState state, Blackhole blackhole) {
        try {
            Pojo10String pojo10 = state.objectMapperMsgPack.readValue(state.bytesMsgPack1_10, Pojo10String.class);
            blackhole.consume(pojo10);
            return pojo10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object msgPackRead10_10(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray10String pojoArray10 = state.objectMapperMsgPack.readValue(state.bytesMsgPack10_10, PojoArray10String.class);
            blackhole.consume(pojoArray10);
            return pojoArray10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object msgPackRead100_10(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray10String pojoArray10 = state.objectMapperMsgPack.readValue(state.bytesMsgPack100_10, PojoArray10String.class);
            blackhole.consume(pojoArray10);
            return pojoArray10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object msgPackRead1000_10(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray10String pojoArray10 = state.objectMapperMsgPack.readValue(state.bytesMsgPack1000_10, PojoArray10String.class);
            blackhole.consume(pojoArray10);
            return pojoArray10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object cborRead1_1(JacksonState state, Blackhole blackhole) {
        try {
            Pojo1String pojo1 = state.objectMapperCbor.readValue(state.bytesCbor1_1, Pojo1String.class);
            blackhole.consume(pojo1);
            return pojo1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object cborRead10_1(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray1String pojoArray1 = state.objectMapperCbor.readValue(state.bytesCbor10_1, PojoArray1String.class);
            blackhole.consume(pojoArray1);
            return pojoArray1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object cborRead100_1(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray1String pojoArray1 = state.objectMapperCbor.readValue(state.bytesCbor100_1, PojoArray1String.class);
            blackhole.consume(pojoArray1);
            return pojoArray1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object cborRead1000_1(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray1String pojoArray1 = state.objectMapperCbor.readValue(state.bytesCbor1000_1, PojoArray1String.class);
            blackhole.consume(pojoArray1);
            return pojoArray1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object cborRead1_10(JacksonState state, Blackhole blackhole) {
        try {
            Pojo10String pojo10 = state.objectMapperCbor.readValue(state.bytesCbor1_10, Pojo10String.class);
            blackhole.consume(pojo10);
            return pojo10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object cborRead10_10(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray10String pojoArray10 = state.objectMapperCbor.readValue(state.bytesCbor10_10, PojoArray10String.class);
            blackhole.consume(pojoArray10);
            return pojoArray10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object cborRead100_10(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray10String pojoArray10 = state.objectMapperCbor.readValue(state.bytesCbor100_10, PojoArray10String.class);
            blackhole.consume(pojoArray10);
            return pojoArray10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object cborRead1000_10(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray10String pojoArray10 = state.objectMapperCbor.readValue(state.bytesCbor1000_10, PojoArray10String.class);
            blackhole.consume(pojoArray10);
            return pojoArray10;
        } catch (IOException e) {
            e.printStackTrace();
