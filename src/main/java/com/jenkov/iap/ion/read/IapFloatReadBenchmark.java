...
import com.jenkov.iap.ion.pojos.Pojo10Float;
import com.jenkov.iap.ion.pojos.Pojo1Float;
import com.jenkov.iap.ion.pojos.PojoArray10Float;
import com.jenkov.iap.ion.pojos.PojoArray1Float;
...
public class IapFloatReadBenchmark {
    ...
    public static class IapState {
        ...
        IonObjectReader reader1       = new IonObjectReader(Pojo1Float.class);
        IonObjectReader readerArray1  = new IonObjectReader(PojoArray1Float.class);
        IonObjectReader reader10      = new IonObjectReader(Pojo10Float.class);
        IonObjectReader readerArray10 = new IonObjectReader(PojoArray10Float.class);
        ...
        public void doSetup() {
            ...
            writerN_10.writeObject(pojoArray1000_10, 2, dest1000_10, 0);
        }
    ...
    public static class JacksonState {
        Pojo1Float  pojo1   = new Pojo1Float();
        Pojo10Float pojo10 = new Pojo10Float();
    ...
    public Object ionRead1_1(IapState state, Blackhole blackhole) {
        Pojo1Float pojo1 = (Pojo1Float) state.reader1.read(state.dest1_1, 0);
    ...
    public Object ionReadArray10_1(IapState state, Blackhole blackhole) {
        PojoArray1Float pojoArray1 = (PojoArray1Float) state.readerArray1.read(state.dest10_1, 0);
    ...
    public Object ionReadArray100_1(IapState state, Blackhole blackhole) {
        PojoArray1Float pojoArray1 = (PojoArray1Float) state.readerArray1.read(state.dest100_1, 0);
        blackhole.consume(pojoArray1);
        return pojoArray1;
    }
    ...
    public Object ionReadArray1000_1(IapState state, Blackhole blackhole) {
        PojoArray1Float pojoArray1 = (PojoArray1Float) state.readerArray1.read(state.dest1000_1, 0);
        blackhole.consume(pojoArray1);
        return pojoArray1;
    }
    ...
    public Object ionRead1_10(IapState state, Blackhole blackhole) {
        Pojo10Float pojo10 = (Pojo10Float) state.reader10.read(state.dest1_10, 0);
    ...
    public Object ionReadArray10_10(IapState state, Blackhole blackhole) {
        PojoArray10Float pojoArray10 = (PojoArray10Float) state.readerArray10.read(state.dest10_10, 0);
    ...
    public Object ionReadArray100_10(IapState state, Blackhole blackhole) {
        PojoArray10Float pojoArray10 = (PojoArray10Float) state.readerArray10.read(state.dest100_10, 0);
        blackhole.consume(pojoArray10);
        return pojoArray10;
    }
    ...
    public Object ionReadArray1000_10(IapState state, Blackhole blackhole) {
        PojoArray10Float pojoArray10 = (PojoArray10Float) state.readerArray10.read(state.dest1000_10, 0);
        blackhole.consume(pojoArray10);
        return pojoArray10;
    }
    ...
    public Object jsonRead1_1(JacksonState state, Blackhole blackhole) {
        try {
            Pojo1Float pojo1 = state.objectMapper.readValue(state.bytesJson1_1, Pojo1Float.class);
            blackhole.consume(pojo1);
            return pojo1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object jsonRead10_1(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray1Float pojoArray1 = state.objectMapper.readValue(state.bytesJson10_1, PojoArray1Float.class);
            blackhole.consume(pojoArray1);
            return pojoArray1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object jsonRead100_1(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray1Float pojoArray1 = state.objectMapper.readValue(state.bytesJson100_1, PojoArray1Float.class);
            blackhole.consume(pojoArray1);
            return pojoArray1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object jsonRead1000_1(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray1Float pojoArray1 = state.objectMapper.readValue(state.bytesJson1000_1, PojoArray1Float.class);
            blackhole.consume(pojoArray1);
            return pojoArray1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object jsonRead1_10(JacksonState state, Blackhole blackhole) {
        try {
            Pojo10Float pojo10 = state.objectMapper.readValue(state.bytesJson1_10, Pojo10Float.class);
            blackhole.consume(pojo10);
            return pojo10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object jsonRead10_10(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray10Float pojoArray10 = state.objectMapper.readValue(state.bytesJson10_10, PojoArray10Float.class);
            blackhole.consume(pojoArray10);
            return pojoArray10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object jsonRead100_10(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray10Float pojoArray10 = state.objectMapper.readValue(state.bytesJson100_10, PojoArray10Float.class);
            blackhole.consume(pojoArray10);
            return pojoArray10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object jsonRead1000_10(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray10Float pojoArray10 = state.objectMapper.readValue(state.bytesJson1000_10, PojoArray10Float.class);
            blackhole.consume(pojoArray10);
            return pojoArray10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object msgPackRead1_1(JacksonState state, Blackhole blackhole) {
        try {
            Pojo1Float pojo1 = state.objectMapperMsgPack.readValue(state.bytesMsgPack1_1, Pojo1Float.class);
            blackhole.consume(pojo1);
            return pojo1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object msgPackRead10_1(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray1Float pojoArray1 = state.objectMapperMsgPack.readValue(state.bytesMsgPack10_1, PojoArray1Float.class);
            blackhole.consume(pojoArray1);
            return pojoArray1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object msgPackRead100_1(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray1Float pojoArray1 = state.objectMapperMsgPack.readValue(state.bytesMsgPack100_1, PojoArray1Float.class);
            blackhole.consume(pojoArray1);
            return pojoArray1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object msgPackRead1000_1(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray1Float pojoArray1 = state.objectMapperMsgPack.readValue(state.bytesMsgPack1000_1, PojoArray1Float.class);
            blackhole.consume(pojoArray1);
            return pojoArray1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object msgPackRead1_10(JacksonState state, Blackhole blackhole) {
        try {
            Pojo10Float pojo10 = state.objectMapperMsgPack.readValue(state.bytesMsgPack1_10, Pojo10Float.class);
            blackhole.consume(pojo10);
            return pojo10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object msgPackRead10_10(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray10Float pojoArray10 = state.objectMapperMsgPack.readValue(state.bytesMsgPack10_10, PojoArray10Float.class);
            blackhole.consume(pojoArray10);
            return pojoArray10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object msgPackRead100_10(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray10Float pojoArray10 = state.objectMapperMsgPack.readValue(state.bytesMsgPack100_10, PojoArray10Float.class);
            blackhole.consume(pojoArray10);
            return pojoArray10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object msgPackRead1000_10(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray10Float pojoArray10 = state.objectMapperMsgPack.readValue(state.bytesMsgPack1000_10, PojoArray10Float.class);
            blackhole.consume(pojoArray10);
            return pojoArray10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object cborRead1_1(JacksonState state, Blackhole blackhole) {
        try {
            Pojo1Float pojo1 = state.objectMapperCbor.readValue(state.bytesCbor1_1, Pojo1Float.class);
            blackhole.consume(pojo1);
            return pojo1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object cborRead10_1(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray1Float pojoArray1 = state.objectMapperCbor.readValue(state.bytesCbor10_1, PojoArray1Float.class);
            blackhole.consume(pojoArray1);
            return pojoArray1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object cborRead100_1(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray1Float pojoArray1 = state.objectMapperCbor.readValue(state.bytesCbor100_1, PojoArray1Float.class);
            blackhole.consume(pojoArray1);
            return pojoArray1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object cborRead1000_1(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray1Float pojoArray1 = state.objectMapperCbor.readValue(state.bytesCbor1000_1, PojoArray1Float.class);
            blackhole.consume(pojoArray1);
            return pojoArray1;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object cborRead1_10(JacksonState state, Blackhole blackhole) {
        try {
            Pojo10Float pojo10 = state.objectMapperCbor.readValue(state.bytesCbor1_10, Pojo10Float.class);
            blackhole.consume(pojo10);
            return pojo10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object cborRead10_10(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray10Float pojoArray10 = state.objectMapperCbor.readValue(state.bytesCbor10_10, PojoArray10Float.class);
            blackhole.consume(pojoArray10);
            return pojoArray10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object cborRead100_10(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray10Float pojoArray10 = state.objectMapperCbor.readValue(state.bytesCbor100_10, PojoArray10Float.class);
            blackhole.consume(pojoArray10);
            return pojoArray10;
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Object cborRead1000_10(JacksonState state, Blackhole blackhole) {
        try {
            PojoArray10Float pojoArray10 = state.objectMapperCbor.readValue(state.bytesCbor1000_10, PojoArray10Float.class);
            blackhole.consume(pojoArray10);
            return pojoArray10;
        } catch (IOException e) {
            e.printStackTrace();
